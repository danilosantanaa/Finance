        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DataUltimaAlteracao = table.Column<DateTime>(type: "timestamp without time zone", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Transacionadores", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Transacionadores_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Transacionadores_Categorias_CategoriaId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TransacionadorId = table.Column<int>(type: "integer", nullable: false),
                    UserId = table.Column<int>(type: "integer", nullable: false),
                    DataCadastro = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    DataUltimaAlteracao = table.Column<DateTime>(type: "timestamp without time zone", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Cobrancas_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Acrescimo = table.Column<double>(type: "double precision", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Recibos_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Recibos_Bancos_BancoId",
                        column: x => x.BancoId,
                        principalTable: "Bancos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Recibos_Cobrancas_CobrancaId",
                        column: x => x.CobrancaId,
                        principalTable: "Cobrancas",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Recibos_Movimentacao_MovimentacaoId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Cobrancas_TransacionadorId",
                table: "Cobrancas",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Recibos_BancoId",
                table: "Recibos",
                column: "BancoId");

            migrationBuilder.CreateIndex(
                name: "IX_Recibos_CobrancaId",
                table: "Recibos",
                column: "CobrancaId");

            migrationBuilder.CreateIndex(
                name: "IX_Recibos_MovimentacaoId",
                table: "Recibos",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Transacionadores_CategoriaId",
                table: "Transacionadores",
                column: "CategoriaId");

            migrationBuilder.CreateIndex(
                name: "IX_Transacionadores_UserId",
                table: "Transacionadores",
                column: "UserId");
        }
